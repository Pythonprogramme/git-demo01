...
# 引入当前app的viws
from orderweb.views import warehouse, service, finance, complete
...
urlpatterns = [
    ...
    path('complete/edits/', complete.edit_value, name="edit_complete"),
    path('complete/del/', complete.del_value, name="del_complete"),
